...
require (
	...
	github.com/go-kratos/kratos/cmd/kratos/v2 v2.0.0-20230706115902-bffc1a0989a6 // indirect
	github.com/go-kratos/kratos/cmd/protoc-gen-go-http/v2 v2.0.0-20230706115902-bffc1a0989a6 // indirect
